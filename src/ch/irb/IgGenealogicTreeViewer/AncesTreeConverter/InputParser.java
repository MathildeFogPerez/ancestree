...
public class InputParser {
    ...
    */
    public InputParser(File airrInputFile, File igPhyMLfile, String cloneId, IgTreeViewerFrame igTreeViewerFrame) throws IOException, JAXBException, SAXException, FastaFormatException {
     ...
     */
    private void rebuildTree(String cloneId) throws IOException {
